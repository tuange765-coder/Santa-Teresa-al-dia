...
# ============================================
# ESTILOS PARA MOVIL (MEJOR VISUALIZACION)
# ============================================
if es_movil:
    st.markdown("""
    <style>
...
# ============================================
# URL DE LA APP (FIJA PARA COMPARTIR)
# ============================================
...
# ============================================
# BOTONES DE COMPARTIR (WhatsApp, Facebook, Instagram, Copiar)
# ============================================
st.markdown("### 📢 Compartir App")

col_share1, col_share2, col_share3, col_share4 = st.columns(4)
...
with col_share2:
    ...
    <a href="{facebook_url}" target="_blank" style="text-decoration: none;">
        <div style="background: #1877F2; padding: 8px; border-radius: 20px; text-align: center;">
            <span style="color: white; font-weight: bold;">Facebook</span>
        </div>
    </a>
    ''', unsafe_allow_html=True)

# Instagram (no tiene API directa, se copia enlace)
with col_share3:
    if st.button("📸 Instagram", key="btn_instagram"):
        copy_to_clipboard_js(APP_URL)
        st.success("¡Enlace copiado! Péguelo en Instagram")
...
with st.sidebar:
    ...
    # INICIALIZAR es_admin COMO False POR DEFECTO
    es_admin = False
...
# ============================================
# CONTENIDO PRINCIPAL - SE MUESTRA EN TODOS LOS DISPOSITIVOS
# ============================================
...
# ============================================
    ...
    with tab_videos:
        ...
        if not videos.empty:
            ...
            st.info("No hay videos disponibles. Sube videos desde el Panel de Control (tamaño maximo 50 MB).")
    ...
    with tab_musica:
        ...
        if not musicas.empty:
            ...
            st.info("No hay musica disponible. Sube archivos MP3 desde el Panel de Control (tamaño maximo 20 MB).")
...
# ============================================
# PANEL DE ADMINISTRACION (SOLO ESCRITORIO Y SI es_admin ES True)
# ============================================
if not es_movil and es_admin:
    ...
    # ADMIN: MUSICA
        ...
        with st.form("form_musica"):
            ...
            archivo = st.file_uploader("Seleccionar audio MP3", type=["mp3", "wav", "ogg"])
            if st.form_submit_button("Subir Musica"):
                if titulo and archivo:
                    if add_musica(titulo, archivo):
                        ...
                        st.error("Error al subir la musica")
                else:
                    st.warning("Complete los campos")
    ...
    # ADMIN: CONFIGURACION
        ...
        if nuevo_logo and st.button("Guardar"):
            ...
            if b64:
                save_logo(b64)
                st.success("Logo guard        if nuevo_logo and st.button("Guardar"):
            b64 = img_a_base64(nuevo_logo)
            if b64:
                save_logo(b64)
