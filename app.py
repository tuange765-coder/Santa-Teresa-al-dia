...
with menu_tabs[0]:
    ...
    # Sección de Música en la portada
...
# ============================================
# TAB 5: MULTIMEDIA - CORREGIDA (TODAS LAS CANCIONES)
# ============================================
with menu_tabs[5]:
    st.title("🎬 Multimedia")
    ...
    with tab_mus:
        ...
        if not musicas.empty:
            ...
            # Mostrar TODAS las canciones (sin límite)
...
if st.session_state.get('es_admin', False):
    ...
    if "📰 Noticias" in admin_opt:
        ...
        st.info("📌 Sube archivos de audio en formato MP3, WAV o OGG")
        with st.form("fmus"):
