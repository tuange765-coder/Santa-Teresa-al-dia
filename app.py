...
# ============================================
# OCULTAR TODOS LOS ELEMENTOS DE DESARROLLO Y ENLACES EXTERNOS
# ============================================
st.markdown("""
<style>
...
.egzxvN1 {display: none !important;}
...
<div style="text-align: center; margin-bottom: 20px;">
    <div style="background: linear-gradient(135deg, #FFD700, #00247D, #CF142B); border-radius: 20px; padding: 20px;">
        ...
        <p style="color: white;">Informacion, Cultura y Fe</p>
    </div>
</div>
""", unsafe_allow_html=True)

# ============================================
# BOTONES DE COMPARTIR (MENSAJE CORTO PARA EVITAR ERROR 413)
# ============================================
