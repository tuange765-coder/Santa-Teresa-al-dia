...
def init_connection():
    try:
        ...
        if test_query.empty:
            st.error("Error de conexión. Contacte al administrador.")
            st.stop()
        return conn
    except Exception:
        st.error("Error de conexión. Contacte al administrador.")
    ...
    try:
        with conn.session as s:
            ...
            cronicas_iniciales = [
                ...
                ("La Batalla de Carabobo", "El 24 de junio de 1821, el Ejército Patriota liderado por Simón Bolívar derrotó a las fuerzas realistas.", "Cronista", "1821", "Campo de Carabobo", "Carabobo"),
                ("Nacimiento del Libertador", "Simón Bolívar nació en Caracas el 24 de julio de 1783.", "Cronista", "1783", "Caracas", "Distrito Capital")
            ]
            ...
            noticias_iniciales = [
                ...
                ("Vinotinto se prepara", "Deportes", "La selección continúa su preparación.", fecha_actual, "Admin"),
                ("Panorama global", "Internacional", "Análisis de los principales sucesos.", fecha_actual, "Admin")
            ]
...
with st.sidebar:
    ...
    if not es_movil:
        ...
        es_admin = False
        # En móvil no se muestra el panel
...
app_url = get_app_url()
whatsapp_url = f"https://api.whatsapp.com/send?text=📱 *Santa Teresa al Dia*%0A%0AInformacion, Cultura y Fe para Nuestra Comunidad%0A%0A🔗 {app_url}"
...
# ============================================
if not es_movil and 'es_admin' in locals() and es_admin:
    st.sidebar.markdown("---")
